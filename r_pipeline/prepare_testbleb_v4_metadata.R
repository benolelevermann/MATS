...
# Dieselbe Kalibrierung wie im bereits funktionierenden TestBleb-v3-Lauf.
PIXEL_WIDTH <- 0.40625
...
case_table <- data.frame(
  ...
  cell_root = c(
    file.path(RUN_ROOT, "04_exported_cells_Bleb_stage6"),
    file.path(RUN_ROOT, "04_exported_cells_DMSO_stage6")
  ),
  original_image = c(
...
# Felder wiederherstellen, die die Legacy-Helfer umsortieren koennen.
...
cat("\n============================================================\n")
cat("TESTBLEB V4 METADATA READY\n")
cat("============================================================\n")
